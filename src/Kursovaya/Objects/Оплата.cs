...
namespace IIS.Kursovaya
{
    ...
    [View("ОплатаE", new string[] {
            ...
            "Заказ.НомерЗаказа"})]
    [MasterViewDefineAttribute("ОплатаE", "Заказ", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "НомерЗаказа")]
    ...
    public class Оплата : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya.Способ1 fСпособ;
        ...
        public virtual IIS.Kursovaya.Способ1 Способ
        {
            get
            {
                ...
                IIS.Kursovaya.Способ1 result = this.fСпособ;
