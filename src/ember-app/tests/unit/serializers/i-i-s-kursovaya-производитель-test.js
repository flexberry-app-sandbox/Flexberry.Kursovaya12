...
moduleForModel('i-i-s-kursovaya-производитель', 'Unit | Serializer | i-i-s-kursovaya-производитель', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya-производитель',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

    'transform:i-i-s-kursovaya-способ1',
